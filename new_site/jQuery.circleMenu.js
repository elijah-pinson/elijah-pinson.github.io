;(function($, window, document, undefined){
    ...
    CircleMenu.prototype.initCss = function(){
        ...
        self.element.children('li:first-child').css({
            ...
            'height': self.options.middle_diameter+'px',
            'position': 'relative',
            'left': ((self.options.item_diameter/2)-(self.options.middle_diameter/2))+'px',
            'top': ((self.options.item_diameter/2)-(self.options.middle_diameter/2))+'px',
            //'line-height': self.options.middle_diameter+'px',
        });
        self.menu_items.css({
            top:0,
            left:0
